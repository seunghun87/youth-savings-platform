...
import { accountProgressPercent, calculatePlanMetrics, estimatedAfterTaxInterest, monthDiff } from "./planMetrics.mjs";
...
const scenarios = [
  ...
  ["큰 목표 사용자", {target:1000000000,current:100000000,unallocated:3000000,accounts:[account({monthly:2000000,remainingMonths:60})]}, {budget:5000000,baseMonths:180,futurePrincipal:120000000}],
